...
import type { RequestVerificationModalProps } from '@/types/dashboard.types';

/**
 * Modal component for requesting verification
 * Displays a list of experiences that can be verified
 */
